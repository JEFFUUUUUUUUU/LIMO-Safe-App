...
// Optimized timing parameters (reduced from original values)
#define FP_STATE_TIMEOUT 250         // Reduced from 500ms to 250ms
#define FP_ENROLLMENT_TIMEOUT 20000  // Reduced from 30000ms to 20000ms
...
// Fast check to see if fingerprint sensor has activity without full processing
bool hasFingerActivity();
